        ...
        <section>
            ...
            <section id='projects' className='bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-16 px-6 md:px-20'>
                ...
                <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
                   {
                    projects.map(p => (
                         <div key={p.id} className='bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-400 rounded-xl overflow-hidden hover:shadow-lg transition duration-300'>
                        ...
                        <div className='p-5'>
                            ...
                            <div className='flex flex-wrap gap-3'>
                                <a href={p.url} className="px-4 py-2 text-sm font-semibold border border-gray-500 text-white rounded hover:bg-gray-950 hover:text-white transition">Live Site</a>
