        ...
        <section id="educations" className="px-4 md:px-24 py-16 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-400">
            ...
            <div className="flex gap-2 pt-3">
                ...
                <div>
                    ...
                    <a href='https://drive.google.com/file/d/1KNoKEhqFePHyphD9spusWV-MKbOAMf0R/view?usp=sharing' target="_blank" className="relative mt-1.5 inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-gray-800 rounded hover:bg-[#c59d5f] group">
            ...
            <div className="flex gap-2 pt-3">
                ...
                <div>
                    ...
                    <a href='https://drive.google.com/file/d/1FTVLLElWwfvPvxk7iI9AM-s_nee9fImv/view?usp=sharing' target="_blank" className="relative mt-1.5 inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-gray-800 rounded hover:bg-[#c59d5f] group">
                        <span className="w-48 h-48 rounded rotate-[-40deg] bg-gray-600 absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
                        <span className="relative w-full text-left text-white transition-colors duration-300 ease-in-out flex gap-2  font-bold group-hover:text-black items-center italic">Certificate <FaEye /></span>
                    </a>
                </div>
